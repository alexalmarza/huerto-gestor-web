...
-- Arreglar la función de desactivación para manejar correctamente la reactivación
...
BEGIN
  ...
  IF NEW.is_active = false AND OLD.is_active = true THEN
    ...
    -- Si se proporciona deactivation_reason, convertirlo a array solo si existe la columna
